...
<html lang="es">
    <head>
    <title>Acceso restringido - Centinela</title>
    <meta charset="utf-8">
                ...
                <div class="error">
                    <div class="container-floud">
                        <div class="col-xs-12 ground-color text-center">
                            ...
                            <h2 class="h1">Lo lamentamos! No posees los permisos necesarios!</h2>
                            {{-- Boton para volver atras --}}
                            <button onclick="goBack()" class="btn btn-primary btn-sm btn-sm"><i class="fa fa-angle-double-left"></i> Volver</button>
                        </div>
                    </div>
                </div>
            <!-- Error Page -->
    ...
    {{-- Script para boton volver atrás --}}
    <script>
        function goBack() {
            window.history.back();
        }
