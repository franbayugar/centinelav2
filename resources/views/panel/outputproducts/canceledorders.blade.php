...
@section('title-head', 'Listado de pedidos cancelados')
...
<section class="content-header">
    <h1>
        <i class="fa fa-times"></i> Pedidos Cancelados
        <small>Listado</small>
    </h1>
    <ol class="breadcrumb">
...
<div class="col-md-12">
    ...
    <div class="box box-info">
        ...
        <div class="box-header">
            <h3 class="box-title"><i class="fa fa-shopping-cart"></i> Listado de pedidos cancelados</h3>
